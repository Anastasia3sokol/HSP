...
ggplot(hsp90[hsp90$species == 'Macaca mulatta' | hsp90$species == 'Gorilla gorilla',], aes(y = RPKM, x = reorder(species, RPKM), fill = species))+
  geom_boxplot()+ 
  facet_wrap( ~ tissue, nrow = 2)+
  theme_bw()+
  ...
  xlab('')+
  ylab('Expression level of HSP90, RPKM')

ggplot(hsp90[hsp90$species == 'mml' | hsp90$species == 'hsa',], aes(y = RPKM, x = reorder(species, RPKM), fill = species))+
  geom_boxplot()+ 
  facet_wrap( ~ tissue, nrow = 2)+
  theme_bw()

ggplot(hsp90[hsp90$species == 'mml' | hsp90$species == 'ppa',], aes(y = RPKM, x = reorder(species, RPKM), fill = species))+
  geom_boxplot()+ 
  facet_wrap( ~ tissue, nrow = 2)+
  theme_bw()

ggplot(hsp90[hsp90$species == 'mml' | hsp90$species == 'ptr',], aes(y = RPKM, x = reorder(species, RPKM), fill = species))+
  geom_boxplot()+ 
  facet_wrap( ~ tissue, nrow = 2)+
  theme_bw()


ggplot(hsp90[hsp90$species == 'mml' | hsp90$species == 'ppy',], aes(y = RPKM, x = reorder(species, RPKM), fill = species))+
  geom_boxplot()+ 
  facet_wrap( ~ tissue, nrow = 2)+
  theme_bw()
...
#####hsc70
ggplot(hsc70, aes(y = RPKM, x = reorder(species, RPKM), fill = species))+
  geom_boxplot()+ 
  facet_wrap( ~ tissue, nrow = 2)+
  theme_bw()
